export const ITEMS = {
    ...
    6: { id: 6, name: "Bandage", use: "heal", price_O2: 100, specialprice_O2: 50, is_special: false, icon: "assets/imgs/items/bandage.png",
        ...
        /* Spéciaux : */
    8: { id: 8, name: "Milk 🌟", use: "food", price_O2: 64, is_special: true, rarity: 1/*0.5*/, icon: "assets/imgs/items/milk.png",
    ...
    5: { id: 5, name: "Mineral Water", use: "heal", price_CO2: 100, specialprice_CO2: 50, is_special: false, icon: "assets/imgs/items/mineral_water.png",
        ...
        /* Spéciaux : */
    9: { id: 9, name: "Bone Meal 🌟", use: "food", price_O2: 64, is_special: true, rarity: 1/*0.5*/, icon: "assets/imgs/items/bone_meal.png",
    ...
    7: { id: 7, name: "Ray of sunshine", use: "resurrector", price_O2: 200, price_CO2: 200, specialprice_O2: 100, specialprice_CO2: 100, is_special: false, icon: "assets/imgs/items/sunshine.png",
        ...
        /* Spéciaux : */
    10: { id: 10, name: "Elixir of life 🌟", use: "resurrector", price_O2: 300, price_CO2: 300, is_special: true, rarity: 1/*0.2*/, icon: "assets/imgs/items/elixir.png",
    ...
    11: { id: 11 , name: "Attack boost potion 🌟", use: "boost", price_O2: 100, price_CO2: 100, is_special: true, rarity: 1/*0.3*/, icon: "assets/imgs/items/attack_boost.png",
    ...
    12: { id: 12, name: "health boost potion 🌟", use: "boost", price_O2: 100, price_CO2: 100, is_special: true, rarity: 1/*0.3*/, icon: "assets/imgs/items/health_boost.png",
    ...
    13: { id: 13, name: "book of knowledge 🌟", use: "boost", price_O2: 150, price_CO2: 150, is_special: true, rarity: 1/*0.2*/, icon: "assets/imgs/items/book_of_knowledge.png",
